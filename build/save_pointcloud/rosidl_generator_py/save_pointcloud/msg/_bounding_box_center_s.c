...
bool save_pointcloud__msg__bounding_box_center__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("save_pointcloud.msg._bounding_box_center.BoundingBoxCenter", full_classname_dest, 58) == 0);
  }
  save_pointcloud__msg__BoundingBoxCenter * ros_message = _ros_message;
  {  // center
...
{
  /* NOTE(esteve): Call constructor of BoundingBoxCenter */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("save_pointcloud.msg._bounding_box_center");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoundingBoxCenter");
