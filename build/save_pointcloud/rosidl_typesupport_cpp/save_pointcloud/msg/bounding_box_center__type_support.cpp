...
static const _BoundingBoxCenter_type_support_symbol_names_t _BoundingBoxCenter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, save_pointcloud, msg, BoundingBoxCenter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, save_pointcloud, msg, BoundingBoxCenter)),
  }
};
...
{
  return &::save_pointcloud::msg::rosidl_typesupport_cpp::BoundingBoxCenter_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, save_pointcloud, msg, BoundingBoxCenter)() {
  return get_message_type_support_handle<save_pointcloud::msg::BoundingBoxCenter>();
}
